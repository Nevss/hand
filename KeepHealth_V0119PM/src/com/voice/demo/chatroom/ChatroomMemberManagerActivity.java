...
public class ChatroomMemberManagerActivity extends GroupBaseActivity {
		...
		public void handleMessage(Message msg) {
			...
			case CCPHelper.WHAT_ON_CHATROOM_KICKMEMBER:
				try {
					closeConnectionProgress();
					if(reason != 0) {
						MyApp.getInstance().showToast(getString(R.string.str_member_kicked_out_failed, reason + ""));
						return;
					}
	...
	public void onResume() {
		...
		MobclickAgent.onPageStart("ChatroomMemberManagerActivity");
	...
	public void onPause() {
		...
		MobclickAgent.onPageEnd("ChatroomMemberManagerActivity");
