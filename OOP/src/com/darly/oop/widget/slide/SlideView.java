 ...
 * TODO
 */
package com.darly.oop.widget.slide;
...
/**
 * @author zhangyh2 SlideView $ 上午11:04:06 TODO
 */
public class SlideView extends HorizontalScrollView {
	...
	public SlideView(Context context, AttributeSet attrs, int defStyle) {
		...
		mScreenWidth = APPEnum.WIDTH.getLen();
	...
	protected void onScrollChanged(int l, int t, int oldl, int oldt) {
		...
		if (scale <= 0.5) {
			ViewHelper.setAlpha(content, 0.5f);
		} else {
			ViewHelper.setAlpha(content, scale);
		}
