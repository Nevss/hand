...
/**
 * 
* <p>Title: ListButtonPopuDialog.java</p>
* <p>Description: 
* 		CCPAlertDialog dialog = new CCPAlertDialog(this
					, R.string.popu_dialog_selcet_c_talk
					, new int[]{R.string.popu_dialog_normal_call,R.string.popu_dialog_call_return}
					, R.string.popu_dialog_selcet_call_free
					, R.string.popu_dialog_cancle);
					
			dialog.setOnItemClickListener(new PopuDialogInterface() {
...
public class CCPAlertDialog {
	...
	public Dialog create(){
		...
		mLlayout.setMinimumWidth(android.view.ViewGroup.LayoutParams.MATCH_PARENT);
