...
public class CCPCapabilityItemView extends LinearLayout {
	...
	private void init(Context context) {
		...
		LinearLayout.LayoutParams bottomLayoutParams = new LinearLayout.LayoutParams(android.view.ViewGroup.LayoutParams.MATCH_PARENT
		...
		LinearLayout.LayoutParams capacitySubLayoutParams = new LinearLayout.LayoutParams(android.view.ViewGroup.LayoutParams.MATCH_PARENT
				,android.view.ViewGroup.LayoutParams.MATCH_PARENT);
	...
	private FrameLayout getCapacityItem(final CapacityType capacityType , final int[] resid) {
		...
		LinearLayout.LayoutParams rfLayoutParams = new LinearLayout.LayoutParams(android.view.ViewGroup.LayoutParams.MATCH_PARENT
				,android.view.ViewGroup.LayoutParams.MATCH_PARENT);
