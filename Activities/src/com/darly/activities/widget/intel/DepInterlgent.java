 ...
 */
public class DepInterlgent extends SurfaceView implements
		SurfaceHolder.Callback, Runnable {

	/**
	 * 上午10:36:51 TODO 机构数据的集合体。包含所有数据信息。
	 */
	private ArrayList<DepFloorRoom> floorRooms;
	...
	public DepInterlgent(Context context, AttributeSet attrs, int defStyleAttr) {
		super(context, attrs, defStyleAttr);
		// TODO Auto-generated constructor stub
		init();
	}

	public DepInterlgent(Context context, AttributeSet attrs) {
		super(context, attrs);
		// TODO Auto-generated constructor stub
		init();
	}

	public DepInterlgent(Context context) {
		super(context);
		// TODO Auto-generated constructor stub
		init();
	}
	...
	private void onDraws() {
		synchronized (holder) {
			try {
				...
				for (int i = 0, length = floorRooms.size(); i < length; i++) {
					paintView(floorRooms.get(i).getPoints(), canvas, paint,
							floorRooms.get(i).getStatus());
				}
				// 画布状态回滚
				canvas.restore();
				canvas.save();
	 ...
	 * 上午10:43:37
	 * 
	 * @author Zhangyuhui DepInterlgent.java TODO
	 */
	public void ReDraw(ArrayList<DepFloorRoom> floorRooms) {
		// TODO Auto-generated method stub
