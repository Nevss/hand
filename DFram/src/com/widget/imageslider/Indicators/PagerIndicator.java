package com.widget.imageslider.Indicators;
 ...
 * Pager Indicator.
 */
public class PagerIndicator extends LinearLayout implements
	 ...
	 * {@link com.daimajia.slider.library.Tricks.ViewPagerEx}
	 */
	...
	/**
	 * This value is from {@link com.daimajia.slider.library.SliderAdapter}
	...
	public PagerIndicator(Context context, AttributeSet attrs) {
		...
		int visibility = attributes.getInt(
				R.styleable.PagerIndicator_visibility,
		...
		int shape = attributes.getInt(R.styleable.PagerIndicator_shape,
				Shape.Oval.ordinal());
		...
		mDefaultUnSelectedHeight = attributes
				.getDimensionPixelSize(
						R.styleable.PagerIndicator_unselected_height,
						(int) pxFromDp(6));
		...
		mPadding_left = attributes.getDimensionPixelSize(
				R.styleable.PagerIndicator_padding_left, (int) pxFromDp(3));
		mPadding_right = attributes.getDimensionPixelSize(
				R.styleable.PagerIndicator_padding_right, (int) pxFromDp(3));
		mPadding_top = attributes.getDimensionPixelSize(
				R.styleable.PagerIndicator_padding_top, (int) pxFromDp(0));
		...
		mSelectedPadding_Left = attributes.getDimensionPixelSize(
				R.styleable.PagerIndicator_selected_padding_left,
				(int) mPadding_left);
		mSelectedPadding_Right = attributes.getDimensionPixelSize(
				R.styleable.PagerIndicator_selected_padding_right,
				(int) mPadding_right);
		mSelectedPadding_Top = attributes.getDimensionPixelSize(
				R.styleable.PagerIndicator_selected_padding_top,
				(int) mPadding_top);
		mSelectedPadding_Bottom = attributes.getDimensionPixelSize(
				R.styleable.PagerIndicator_selected_padding_bottom,
				(int) mPadding_bottom);

		mUnSelectedPadding_Left = attributes.getDimensionPixelSize(
				R.styleable.PagerIndicator_unselected_padding_left,
				(int) mPadding_left);
		mUnSelectedPadding_Right = attributes.getDimensionPixelSize(
				R.styleable.PagerIndicator_unselected_padding_right,
				(int) mPadding_right);
		mUnSelectedPadding_Top = attributes.getDimensionPixelSize(
				R.styleable.PagerIndicator_unselected_padding_top,
				(int) mPadding_top);
		mUnSelectedPadding_Bottom = attributes.getDimensionPixelSize(
				R.styleable.PagerIndicator_unselected_padding_bottom,
				(int) mPadding_bottom);
	...
	public void setDefaultUnSelectedPadding(float left, float top, float right,
		...
		if (unit == Unit.DP) {
			...
			mUnSelectedLayerDrawable.setLayerInset(0, (int) left, (int) top,
					(int) right, (int) bottom);
