 ...
 * $UserInfoFragment类中点击意见反馈调用本类
 * 下午5:54:11
 * TODO 本类处理用户意见，并进行用户意见上传。包括图片和文字。
 */
public class OpinionFeedbackActivity extends BaseActivity implements Callback {
	 ...
	 * 
	 * 同样的一个东西监听EditText，EditText有自身的一个监听事件。为什么要启动一个Timer呢。到底Timer有什么好的。
	 */
